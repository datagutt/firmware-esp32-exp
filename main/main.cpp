...
extern "C" void app_main(void) {
  ...
  ret = xTaskCreatePinnedToCoreWithCaps(
      runtime_coordinator_task, "runtime_coord", RUNTIME_TASK_STACK_SIZE,
      nullptr, RUNTIME_TASK_PRIORITY, nullptr, tskNO_AFFINITY,
...
#endif
  if (ret != pdPASS) {
    ret = xTaskCreate(runtime_coordinator_task, "runtime_coord",
